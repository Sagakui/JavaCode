...
public class Main {
    ...
    private static Logger loggerFoInfo;
    private static Logger loggerFoError;
    private static Logger loggerFoWarn;

    public static void main(String[] args) {
        RouteCalculator calculator = getRouteCalculator();
        loggerFoInfo = LogManager.getLogger("searchLogger");
        loggerFoError = LogManager.getLogger("errorLogger");
        loggerFoWarn = LogManager.getLogger("exLogger");
        ...
        for (;;) {
            try {
                ...
                loggerFoWarn.log(Level.WARN,"Entering the same station to build a route.");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                loggerFoInfo.log(Level.INFO,"Station Requested: " + station);
                return station;
            }
            loggerFoError.log(Level.ERROR, "Station not found: " + line);
